...
public class CorridaCarro {
	...
	public void preparar() {
		...
		System.out.println("A corrida vai comecar. -  " + quantidadeCarro + " Carro correndo um percurso de "
				+ distanciaTotal + "M. ");
	...
	public void exibirResultado() {
		corridaControle.getCarrosChegada()
				.forEach((k, v) -> System.out.println(new String(k + "- lugar - " + ((Carro) v).getNome())));
	}
}
